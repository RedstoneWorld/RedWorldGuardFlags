...
| `spawnegg-use`             | Boolean    | Toggles whether entities can spawn when a player uses spawn-eggs. (subordinate to the "mob-spawning" flag and "build" flag ¹)                                                                            | allow         |
| `spawnegg-dispense`        | Boolean    | Toggles whether entities can spawn when a `dispenser` uses spawn-eggs. (subordinate to the "mob-spawning" flag)                                                                                          | allow         |
| `vanilla-spawning`         | Boolean    | Toggles whether entities can spawn by all kinds of natural Vanilla behavior (= not via spawn-eggs, commands, or plugins). (subordinate to the "mob-spawning" flag)                                       | allow         |
